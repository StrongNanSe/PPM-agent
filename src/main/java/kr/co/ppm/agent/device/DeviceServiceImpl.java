...
public class DeviceServiceImpl implements DeviceService{
    ...
    public void sendParasolStatus() {
        ...
        //파라솔아이디
        String id = properties.getProperty("parasolId");
        //각도
        ...
        parasolStatusInfo.append("{");

        parasolStatusInfo.append("{").append("\"").append("id").append("\":\"").append(id).append("\",")
       ...
       try{
            String response = postDeviceInfo("http://localhost/status", parasolStatusInfo.toString());
    ...
    public static void main(String[] args) {
        new DeviceServiceImpl().sendParasol();
    }
    ...
    public void sendParasol() {
        ...
        try{
            String response = postDeviceInfo("http://localhost/parasol", parasolInfo.toString().replace("parasolId", "id"));
            logger.info(response);
        } catch (Exception e) {
            //오류 처리 필요
    ...
    private String postDeviceInfo(String url, String postBody) throws IOException {
